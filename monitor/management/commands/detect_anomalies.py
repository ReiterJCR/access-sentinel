    ...
    def handle(self, *args, **kwargs):
        ...
        for i, log in enumerate(access_logs):
            ...
            if country not in known_countries and known_countries:
                anomalies.append({
                    "type": "GeoIP Mismatch",
                    "detail": f"User accessed from new country {country} (previous: {', '.join(known_countries)})",
                    "severity": 3
                })
            ...
            if hour < 9 or hour > 18:
                anomalies.append({
                    ...
                    "detail": f"Access at {hour}:00 UTC (outside working hours)",
                    "severity": 2
                })
            ...
            if window_logs.count() > 20:
                anomalies.append({
                    ...
                    "detail": f"{window_logs.count()} file accesses within 10 minutes",
                    "severity": 4
                })

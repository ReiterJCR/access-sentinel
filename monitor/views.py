...
from .models import AccessLog, User, File, AnomalyLog
...
IP_POOL = [
    "8.8.8.8", "104.26.10.228", "203.0.113.5",
    "185.199.110.153", "198.51.100.42"
]
...
def admin_dashboard(request):
    ...
    user_anomalies = (
        AnomalyLog.objects
        .values("access_log__user__id", "access_log__user__name")
